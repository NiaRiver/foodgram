    ...
    <Container>
      ...
      <div className={styles.content}>
        ...
        <aside>
          ...
          <div className={styles.text}>
            <p className={styles.textItem}>
              Код проекта находится тут - <a href="https://github.com/NiaRiver/foodgram/" className={styles.textLink}>Foodgram Github</a>
            </p>
            <p className={styles.textItem}>
              Автор проекта: <a href="https://github.com/NiaRiver/" className={styles.textLink}>Nate River</a>
            </p>
          </div>
        </aside>
      </div>
